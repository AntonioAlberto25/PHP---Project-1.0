...
<div class="mb-8 mt-5">
    ...
    <div class="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        ...
        <!-- New Order Button -->
        <button id="openModal" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-md transition-colors duration-200 flex items-center gap-2">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php require '../views/modals/createOrder.php' ?>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
    ...
    <div class="bg-white border border-gray-200 rounded-lg p-5 hover:shadow-lg transition-all duration-200">
        ...
        <div class="flex items-center text-sm text-gray-500 mb-4">
            ...
            <span><?= htmlentities($order->date_entrega) ?></span>
        </div>
        ...
        <div class="flex items-center gap-2 pt-3 border-t border-gray-100">
            <button class="bg-blue-600 hover:bg-blue-700 text-white text-sm px-3 py-1.5 rounded transition-colors duration-200 flex items-center gap-1" 
                    onclick="window.location.href='/pedido?id=<?= $order->id ?>'">
