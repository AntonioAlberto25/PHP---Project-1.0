<?php
$validacoes = flash()->get('validacoes_edit-receita');
?>
...
<form action="/receitas/edit" method="POST" class="space-y-6">
    <input type="hidden" name="__method" value="PUT" id="form-edit">
     <input type="hidden" name="id" value="<?=$receita->id?>" id="form-edit">
    ...
    <label for="preco" class="label">
        ...
        <label class="input-group">
            <input
                ...
                value="<?= htmlspecialchars($old['preco'] ?? $receita->preco) ?>" />
        </label>
        ...
        <label class="input-group">
            <input
                ...
                value="<?= htmlspecialchars($old['rendimento'] ?? $receita->rendimento) ?>" />
        </label>
    ...
    <div class="form-control">
        ...
        <textarea
            ...
            placeholder="Descreva os detalhes da receita, ingredientes principais ou o modo de preparo..."><?= htmlspecialchars($old['descricao'] ?? $receita->descricao) ?></textarea>
        <label class="label">
