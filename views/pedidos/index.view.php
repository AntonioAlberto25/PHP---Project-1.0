<div class="mb-8 mt-5">
    ...
    <div class="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        ...
        <a href="/pedidos/criar" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md transition-colors duration-200 flex items-center gap-2">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php if (empty($pedidos)): ?>
    <div class="text-center py-16">
        ...
        <h3 class="mt-2 text-sm font-medium text-gray-900">Nenhuma pedido encontrada</h3>
        <p class="mt-1 text-sm text-gray-500">Comece cadastrando seu primeiro pedido.</p>
    </div>
<?php else: ?>
    <?php
    ...
    $pedidosPaginadas = array_slice($pedidos, $offset, $itensPorPagina);
    ?>
    ...
    <div class="overflow-x-auto bg-white rounded-lg shadow mt-5">
        <table class="table w-full">
            ...
            <tbody>
                <?php foreach ($pedidosPaginadas as $pedido): ?>
                    <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-150">
                        ...
                        <td class="py-4">
                            <div class="flex items-center justify-center gap-2">
                                <a href="/pedidos/visualizar?id=<?= $pedido->id ?>" 
                                ...
                                <a href="/pedidos/edit?id=<?= $pedido->id ?>" 
                                ...
                                <form method="POST" action="/pedidos" class="inline">
